...
public class BDIngresosConsultas {
    ...
    //              select DESCRIPCION,MEDIDA,C_SANTAINES as CANTIDAD from productos_pedido pp inner join productos p on pp.ID_PRODUCTO = p.ID_PRODUCTO where ID_PEDIDO = 16 and C_SANTAINES > 0;
