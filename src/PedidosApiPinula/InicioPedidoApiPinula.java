 ...
 */
package PedidosApiPinula;

import BDclass.BDConexionPedidosPinula;
 ...
 * @author it
 */
public class InicioPedidoApiPinula extends javax.swing.JFrame {
     ...
     */
    public InicioPedidoApiPinula() throws Exception {
        initComponents();
    ...
    public void insertarProducto() {
        try {
            BDApiRestPinula.agregarProductoAlPedido(Integer.parseInt(NoPedido.getText()), id_producto);
            id_producto = 0;
    ...
    private void ListarPedidos() throws Exception {
        ArrayList<ClassProductosApiPinula> result = BDApiRestPinula.ListarPedidos(1);
        RecargarTablaPedidos(result);
    }

    private void RecargarTablaPedidos(ArrayList<ClassProductosApiPinula> list) {
        Object[][] datos = new Object[list.size()][2];
        int i = 0;
        for (ClassProductosApiPinula t : list) {
    ...
    private void ListarProductos() throws Exception {
        ArrayList<ClassProductosApiPinula> result = BDApiRestPinula.obtenerProductos(Integer.parseInt(NoPedido.getText()));
        RecargarTablaDetallado(result);
    }

    private void RecargarTablaDetallado(ArrayList<ClassProductosApiPinula> list) {
    ...
    private void ListarProductosSolicitados() throws Exception {
        ArrayList<ClassProductosApiPinula> result = BDApiRestPinula.ProductosSolicitados(
                Integer.parseInt(NoPedido.getText()), Sucursal);
        RecargarTabla(result);
    }

    private void RecargarTabla(ArrayList<ClassProductosApiPinula> list) {
        ...
        model.addTableModelListener(new TableModelListener() {
            ...
            public void tableChanged(TableModelEvent e) {
                if (e.getType() == TableModelEvent.UPDATE && e.getColumn() == 3) {
                    ...
                    BDApiRestPinula.actualizarCantidad(id_pedido, id_producto, Sucursal, cantidad);
                }
            }
        });
    }
   ...
   /* private void imprimir() {
    ...
    private void imprimir() {
    BDConexionPedidosPinula con = new BDConexionPedidosPinula();
    Connection conexion = con.getConexion();
    ...
    private void TablePedidosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TablePedidosMouseClicked
        if (bloqueo == 0) {
            ...
            try {
                ...
                Logger.getLogger(InicioPedidoApiPinula.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InicioPedidoApiPinula.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new InicioPedidoApiPinula().setVisible(true);
                } catch (Exception ex) {
                    Logger.getLogger(InicioPedidoApiPinula.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
