 ...
 * @author it
 */
public class AceptarPedidoApiPinula extends javax.swing.JFrame {
  int id_producto;
  int Sucursal = 0;
  int bloqueo = 0;
    /**
     ...
     */
    public AceptarPedidoApiPinula() throws Exception {
        initComponents();
    ...
    private void ListarPedidos() throws Exception {
        ...
        ArrayList<ClassProductosApiPinula> result = BDApiRestPinula.ListarPedidos(2);
    ...
    private void ListarProductosRecibidos() throws Exception {
        ArrayList<ClassProductosApiPinula> result = BDApiRestPinula.ProductosRecibidos(Integer.parseInt(NoPedido.getText()), Sucursal );
        RecargarTablaReci(result);
    }

    private void RecargarTablaReci(ArrayList<ClassProductosApiPinula> list) {
        ...
        model.addTableModelListener(new TableModelListener() {
            ...
            public void tableChanged(TableModelEvent e) {
                if (e.getType() == TableModelEvent.UPDATE && e.getColumn() == 3) {
                    ...
                    BDApiRestPinula.actualizarCantidadRecibida(id_pedido, id_producto, Sucursal, cantidad);
                }
            }
        });
    }
    ...
    private void TablePedidosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TablePedidosMouseClicked
      try {
          ...
          Logger.getLogger(AceptarPedidoApiPinula.class.getName()).log(Level.SEVERE, null, ex);
      }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AceptarPedidoApiPinula.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new AceptarPedidoApiPinula().setVisible(true);
                } catch (Exception ex) {
                    Logger.getLogger(AceptarPedidoApiPinula.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
