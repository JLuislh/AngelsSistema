 ...
 * @author jluis
 */
public class MenuParaiso extends javax.swing.JFrame {
     ...
     * @param b
     */
    public MenuParaiso(int a,int b) {
        initComponents();
        setLocationRelativeTo(null);
        this.nomesa = a;
        MenuParaiso.noorden = b;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuParaiso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
